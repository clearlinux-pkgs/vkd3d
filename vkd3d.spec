...
Source0  : https://dl.winehq.org/vkd3d/source/vkd3d-1.4.tar.xz
Source1  : https://dl.winehq.org/vkd3d/source/vkd3d-1.4.tar.xz.sign
...
%prep
%setup -q -n vkd3d-1.4
cd %{_builddir}/vkd3d-1.4
pushd ..
cp -a vkd3d-1.4 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655996218
...
cp %{_builddir}/vkd3d-1.4/LICENSE %{buildroot}/usr/share/package-licenses/vkd3d/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd ../build32/
%make_install32
...
/usr/lib64/libvkd3d-shader.so.1.2.0
/usr/lib64/libvkd3d-utils.so.1
/usr/lib64/libvkd3d-utils.so.1.3.0
/usr/lib64/libvkd3d.so.1
/usr/lib64/libvkd3d.so.1.4.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvkd3d-shader.so.1
/usr/lib32/libvkd3d-shader.so.1.2.0
/usr/lib32/libvkd3d-utils.so.1
/usr/lib32/libvkd3d-utils.so.1.3.0
/usr/lib32/libvkd3d.so.1
/usr/lib32/libvkd3d.so.1.4.0
